...
export function AuthField({
  ...
  return (
    <label className="field">
      ...
      <span className="flex overflow-hidden rounded-md border border-pink-100 bg-stone-50 transition-colors focus-within:border-pink-300 focus-within:bg-white">
        <input
